...
const MIDIA_TABS = [
  ...
  { id: 'cobertura', label: '▚ Cobertura do Evento', icon: '▚' }
];
...
export default function PerfilMidia() {
  ...
  // Access denied
  if (!userData || userData.role !== 'midia') {
    return (
      <div className="min-h-screen bg-gradient-to-br from-black via-[#0a0a1a] to-[#0038d0] flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-white mb-4">Acesso Negado</h1>
          <p className="text-gray-300 mb-4">Esta página é exclusiva para mídia.</p>
          <button
...
function TabContent({ activeTab, userData, leaderboardProvas, gamification }: TabContentProps) {
  switch (activeTab) {
    ...
    case 'cobertura':
      return <CoberturaTab userData={userData} />;
    default:
      return <ProfileTab userData={userData} gamification={gamification} />;
  }
}
      ...
      <div className="bg-gradient-to-br from-purple-500 to-pink-600 rounded-2xl p-6 text-white shadow-xl">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-purple-100 text-sm">Detalhes da sua conta e conquistas</p>
            </div>
          </div>
        ...
        <div className="bg-white/10 rounded-xl p-4 backdrop-blur-sm">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-purple-100 mb-1">Seu Status</p>
            ...
            <div className="text-right">
              <p className="text-sm text-purple-100 mb-1">Conquistas</p>
      ...
      <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-purple-500/20 rounded-xl p-4 text-center">
            <div className="text-2xl font-bold text-purple-300">{gamification?.box_tokens || 0}</div>
            <div className="text-sm text-purple-200">$BØX Total</div>
          </div>
          <div className="bg-pink-500/20 rounded-xl p-4 text-center">
            <div className="text-2xl font-bold text-pink-300">0</div>
            <div className="text-sm text-pink-200">Conquistas</div>
          </div>
        </div>
      </div>
          ...
          <div className="group bg-white/10 backdrop-blur-md rounded-2xl p-5 border border-white/20 transition-all duration-300 hover:bg-white/15 hover:scale-[1.02] hover:shadow-xl">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-bold text-lg">Primeira Cobertura</p>
                  <p className="text-blue-100 text-sm">Faça sua primeira cobertura do evento</p>
                </div>
              </div>
              <div className="text-right">
                <div className="text-2xl font-bold text-pink-300">75</div>
                <div className="text-blue-100 text-sm">$BØX</div>
                <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-medium bg-pink-500/20 text-pink-300 border border-pink-400/30 mt-2 backdrop-blur-sm">
...
// Cobertura Tab
function CoberturaTab({ userData }: { userData: UserData }) {
  // ============================================================================
  // 🚧 BETA FEATURES - SISTEMA DE COBERTURA
  // ============================================================================
  // Status: Estrutura pronta, aguardando integração com sistema de mídia
  // Prioridade: Alta
  // Estimativa: 2-3 sprints
  // Dependências: Sistema de upload, galeria de mídia, aprovação de conteúdo
  // ============================================================================
    ...
    <div className="space-y-6">
      <div className="bg-gradient-to-br from-purple-500 to-pink-600 rounded-2xl p-6 text-white shadow-xl">
        <div className="flex items-center space-x-3 mb-4">
          ...
          <div>
            <h2 className="text-xl font-bold">Cobertura do Evento</h2>
            <p className="text-purple-100 text-sm">Ferramentas e recursos para sua cobertura</p>
          </div>
        </div>
        ...
        <div className="bg-white/10 rounded-xl p-4 backdrop-blur-sm">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-purple-100 mb-1">Coberturas Realizadas</p>
              <p className="text-2xl font-bold">0</p>
            </div>
            <div className="text-right">
              <p className="text-sm text-purple-100 mb-1">Próximas Coberturas</p>
              <p className="text-lg font-bold">0</p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-purple-500/20 rounded-xl p-4">
            <h4 className="font-semibold text-white mb-2">📸 Área de Fotografia</h4>
            <p className="text-purple-200 text-sm">Acesso exclusivo às áreas de fotografia</p>
          </div>
          <div className="bg-pink-500/20 rounded-xl p-4">
            <h4 className="font-semibold text-white mb-2">🎥 Área de Vídeo</h4>
            <p className="text-pink-200 text-sm">Espaços dedicados para gravação</p>
          </div>
          <div className="bg-blue-500/20 rounded-xl p-4">
            <h4 className="font-semibold text-white mb-2">📝 Press Kit</h4>
            <p className="text-blue-200 text-sm">Material oficial do evento</p>
          </div>
          <div className="bg-green-500/20 rounded-xl p-4">
            <h4 className="font-semibold text-white mb-2">🎤 Entrevistas</h4>
            <p className="text-green-200 text-sm">Agendamento de entrevistas</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
        ...
        <div className="text-center py-12 text-gray-400">
          ...
          <p className="text-lg font-medium mb-2">Nenhuma Cobertura</p>
          <p className="text-sm">Você ainda não realizou coberturas</p>
        </div>
      </div>
    </div>
  );
