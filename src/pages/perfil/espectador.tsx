        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 mb-6">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-300">Espectador • {userData.cidade || 'Cidade não informada'}</p>
            </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-green-500/20 rounded-xl p-4 text-center">
            <div className="text-2xl font-bold text-green-300">{userBoxes}</div>
      ...
      <div className="bg-gradient-to-r from-green-500 to-emerald-500 rounded-2xl p-6 text-white shadow-xl">
        ...
        <p className="text-green-100 text-sm mb-6">$BØX já conquistados</p>
        
        <div className="text-center py-8">
          <div className="text-4xl mb-2">🎯</div>
          <p className="text-green-100">Complete missões para ganhar $BØX!</p>
          <p className="text-green-200 text-sm">Sistema de gamificação em desenvolvimento</p>
        </div>
      </div>
