        ...
        >
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-6">
              <a href="/" className="text-white hover:text-pink-400 text-sm font-medium">
                Home
              </a>
              <a href="/sobre" className="text-white hover:text-pink-400 text-sm font-medium">
                Sobre
              </a>
              <a href="/audiovisual" className="text-pink-400 hover:text-pink-300 text-sm font-medium">
                Audiovisual
              </a>
              <a href="/loja" className="text-pink-400 hover:text-pink-300 text-sm font-medium">
                Loja
              </a>
              <a href="/captacao/judge-staff" className="text-pink-400 hover:text-pink-300 text-sm font-medium">
                Judges e Staff
              </a>
              <a href="/patrocinadores" className="text-pink-400 hover:text-pink-300 text-sm font-medium">
            ...
            <motion.button
              onClick={toggleMenu}
              className="md:hidden flex flex-col justify-center items-center w-7 h-7 text-white hover:text-pink-400 transition-colors duration-300 relative"
              whileTap={{ scale: 0.95 }}
